                                                                ...
                                                                const FGameplayTag& InCooldownTag)
{
	...
	.AddUObject(WaitCooldownChange, &UWaitCooldownChange::CoolTagChanged);
...
void UWaitCooldownChange::CoolTagChanged(const FGameplayTag InCooldownTag, int32 NewCount)
{
	if(NewCount == 0)
	{
